...
const MuiDataGrid: Components<Theme>['MuiDataGrid'] = {
  ...
  defaultProps: {
    slotProps: {
      baseCheckbox: { disableRipple: true, size: 'small' },
      baseChip: { size: 'small' },
    ...
    slots: {
      columnFilteredIcon: (props: SvgIconProps) => (
        <DataGridFilterIcon sx={{ color: 'text.primary', width: 16 }} {...props} />
      ),
      ...
      quickFilterIcon: (props: SvgIconProps) => (
        <DataGridSearchIcon sx={{ color: 'text.secondary', height: 24, width: 24 }} {...props} />
      )
    }
  },
  ...
  styleOverrides: {
    ...
    cell: ({ theme }) => ({
      '&--editing': {
        backgroundColor: varAlpha((theme.vars || theme).palette.primary.mainChannel, 0.08),
        boxShadow: 'none'
      },
     ...
     */
    columnHeader: ({ theme }) => ({
      '&--sorted': { color: (theme.vars || theme).palette.text.primary },
    ...
    filterFormDeleteIcon: ({ theme }) => ({
      [`& .${iconButtonClasses.root}`]: {
        [`& .${svgIconClasses.root}`]: { height: 16, width: 16 },
     ...
     * Footer
     */
    footerContainer: { borderTopStyle: 'dashed', minHeight: 'auto' },
    ...
    overlay: ({ theme }) => ({
      [`& .${circularProgressClasses.root}`]: { color: (theme.vars || theme).palette.text.primary }
    }),
    /**
     * Paper
     */
    ...
    root: ({ theme }) => ({
      '--DataGrid-containerBackground': (theme.vars || theme).palette.background.neutral,
...
export function DataGridArrowUpIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
...
export function DataGridArrowDownIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
...
export function DataGridFilterIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
...
export function DataGridExportIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
        clipRule='evenodd'
...
export function DataGridEyeIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
...
export function DataGridEyeCloseIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
        clipRule='evenodd'
...
export function DataGridSearchIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
...
export function DataGridCloseIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
...
export function DataGridMoreIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <g fill='none'>
...
export function DataGridDensityCompactIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <path
...
export function DataGridDensityComfortableIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
...
export function DataGridDensityStandardIcon({ ...props }: SvgIconProps) {
  return (
    <SvgIcon sx={{ height: 20, width: 20, ...props.sx }} {...props}>
      <g fill='none'>
        <path d='M24 0v24H0V0zM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018m.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022m-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01z' />
